...
public:
    ...
    Node* getNodeByRowCol(int row, int col, NodeList* nodeList);
    bool existsInList(int row, int col, NodeList* nodeList);
    bool validateByDirection(int row, int col, int distance, NodeList* nodeList, Env env);
